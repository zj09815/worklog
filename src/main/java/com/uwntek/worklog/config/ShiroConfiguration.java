...
import com.uwntek.worklog.filter.URLPathMatchingFilter;
import com.uwntek.worklog.realm.UWRealm;
...
*/
    ...
    public SecurityManager securityManager() {
        ...
        securityManager.setRealm(getUWRealm());
    ...
    @Bean
    public UWRealm getUWRealm() {
        UWRealm uwRealm = new UWRealm();
        uwRealm.setCredentialsMatcher(hashedCredentialsMatcher());
        return uwRealm;
    }
