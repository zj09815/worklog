...
public class ChunkService {
    public String chunkUploadByMappedByteBuffer(MultipartFileParam param, String filePath)
            throws IOException, NotSameFileExpection {
        ...
        if (isComplete) {
            ...
            String newFilename = df.format(new Date()) + com.uwntek.worklog.util.StringUtils.getRandomString(10)
                    + fileName;
